...
| Threat Detection & Hunting | [Threat Hunting Scenario — Tor](https://github.com/Felixatika/Threat-hunting-scenario-tor) | Detected and investigated Tor browser usage on an endpoint using Microsoft Defender for Endpoint and KQL queries. | KQL, Windows 11 VM, Microsoft Defender for Endpoint |
...
| Vulnerability & Compliance | [DISA-STIGs](https://github.com/Felixatika/DISA-STIGs) | Applied and audited DISA STIG compliance baselines on a Windows 11 VM. | Windows 11 VM, Tenable, DISA, STIG, PowerShell |
